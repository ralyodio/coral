...
impl ServerBuilder {
    ...
    #[expect(
        ...
        reason = "linear bootstrap sequence wiring the database-backed state store"
    )]
...
mod tests {
    ...
    use super::{
        ...
        is_native_grpc_content_type, resolve_configured_credential_encryption_key, start_server,
    };
